...
WEBSOCKET_PATH = os.getenv("WEBSOCKET_PATH", "/xiaozhi/v1/")
...
TTS_VOICE = os.getenv("TTS_VOICE", "nova") # Changed from "alloy" to "nova" which works better for Chinese
...
AZURE_SPEECH_RECOGNITION_LANGUAGE = os.getenv("AZURE_SPEECH_RECOGNITION_LANGUAGE", "zh-CN")
AZURE_SPEECH_SYNTHESIS_LANGUAGE = os.getenv("AZURE_SPEECH_SYNTHESIS_LANGUAGE", "zh-CN")
